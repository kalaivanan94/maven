...
<style>
  ...
  .carousel-inner > .item > a > img {
    ...
    <a class="navbar-brand"><img src="<c:url value='resources/image/img.jpg'/>"style="width:100px;height:30px;"/></a>
   </div>
...
<nav class="navbar navbar-inverse navbar-fixed-bottom">
    ...
    <a class="navbar-brand" href="#"><h4><span class="glyphicon glyphicon-copyright-mark"></span>2016 PetWorld. All Rights Reserved</h4></a>
   </div>
   </div>
   </nav>
