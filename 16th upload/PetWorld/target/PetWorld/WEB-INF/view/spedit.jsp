		...
		<form:form id="registerForm"  method="post"
			...
			<table width="400px" height="100px">
                ...
                <td><label for="Id">SUPPLIER ID</label></td>
                    <td><form:input type="text" path="spid" value="${spList.spid}" readonly="true"/></td>
                </tr>
                <tr>
                <td><label for="name">Supplier Name</label></td>
                    <td><form:input type="text" path="spname" value="${spList.spname}"/></td>
                </tr>
                <tr>
                <td><label for="name">Supplier Place</label></td>
                   <td> <form:input type="text" path="splace" value="${spList.splace}"/></td>
                   </tr>
                </table>
                <br>
