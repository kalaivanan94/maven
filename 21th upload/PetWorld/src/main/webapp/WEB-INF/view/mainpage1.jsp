...
<body style="background-color: powderblue;">
	...
	<div class="container-fluid">
		...
		<ul class="nav navbar-nav navbar-right">
			...
			<li><a href="cartlist"> <span class="glyphicon glyphicon-shopping-cart"></span>CART </a></li>
			<li><a href="membership"><span class="glyphicon glyphicon-user"></span>
					SIGN UP</a></li>
			<li><a href="logiin"><span class="glyphicon glyphicon-log-out"></span>
					LOGOUT</a></li>
...
<!-- 			<div class="row"> -->
			<div class="col-md-4">
				...
				<div class="thumbnail">
						...
						<a href="addtocart?id=${user.pid}"><button
									class="btn btn-primary" role="button" type="submit">ADD TO CART</button>
						</center>
					<br>
				</div>
				<br>
