				...
				<table width="400px" height="200px">
					...
					<tr>
						...
						<td> <select>
								...
								<option label="PUPPIES">PUPPIES</option>
								<option label="CAT">CAT</option>
								<option label="KITTENS">KITTENS</option>
						</select></td>
					</tr>
					<tr>
						<td><form:label path="name">SUPPLIER NAME</form:label></td>
						<td> <select>
								<option label="KALAI">KALAI</option>
								<option label="WALTER">WALTER</option>
								<option label="KEERTHI">KEERTHI</option>
								<option label="VIVEK">VIVEK</option>
								<option label="GUGAN">GUGAN</option>
						</select></td>
					</tr>
